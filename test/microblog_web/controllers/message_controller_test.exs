defmodule MicroblogWeb.MessageControllerTest do
  ...
  @create_attrs %{date: ~D[2010-04-17], desc: "some desc", user: "some user"}
  @update_attrs %{date: ~D[2011-05-18], desc: "some updated desc", user: "some updated user"}
  @invalid_attrs %{date: nil, desc: nil, user: nil}
